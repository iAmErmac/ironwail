...
The CMake build automatically copies `Quake/ironwail.pak` beside the executable, including `build/Debug/ironwail.pak`. The source pak is treated as user-provided engine content and is not regenerated by CMake.